...
export const defaultClausula = (
  ...
  derivados del Proyecto; que será desarrollada por el Gestor bajo la forma jurídica de un contrato de cuentas en participación. 
  Las Partes declaran expresamente que las relaciones que se deriven del presente
  ...
  <h2>PARTICIPACIÓN EN EL RESULTADO. </h2>
  <p>
  En contraprestación a su Aportación, el Cuentapartícipe, a su riesgo y ventura, junto con el Gestor,
  adquiere el derecho a participar en el resultado del Proyecto en el mismo porcentaje que representa la Aportación, esto es, 
  en ${cuenta_descripcion_resultado_calculo} (los “Derechos Económicos”). 
  ...
  En el supuesto de discrepancia sobre el resultado del Proyecto cualquiera de las partes podrá solicitar a la firma de auditoría que estime conveniente la emisión de un informe de cuantificación.
  El Gestor se obliga a suministrar a los auditores seleccionados por el Cuentaparticipe la documentación necesaria para esa tarea.
  ...
  <h2>DETERMINACIÓN DEL RESULTADO. </h2>
  <p>
  ...
  El Gestor podrá realizar la emisión de un criptoactivo no fungible (en adelante, “NFT”) sobre tecnología de registros distribuidos a través de su página web corporativa entregándoselo al Cuentapartícipe o permitiéndole acceso al mismo.
  Dicho NFT actuará como resguardo y elemento que habilita a acceder la información entregada por el Gestor en relación al Proyecto en el marco del presente Contrato pero no dará en ningún caso lugar a la asociación de derechos económicos derivados del Contrato con el mismo.
  </p>
  ...
  <h2>CAUSAS DE EXTINCIÓN DEL CONTRATO. </h2>
  <p>
  ...
  <h2>DOMICILIO Y NOTIFICACIONES.</h2>
<p>
 ...
 <h2> NATURALEZA DEL CONTRATO Y RESPONSABILIDAD. </h2>
 ...
 <h2> NULIDAD DE ALGUNA ESTIPULACIÓN. </h2>
   
 <p> La nulidad o invalidez de alguna de las estipulaciones contenidas en el presente Contrato, no afectará en forma alguna, la validez de las demás estipulaciones, ni causará, en ningún caso, la nulidad o invalidez del presente Contrato. 
 </p>  
  ...
  <h2>INTERVENCIÓN DE FEDATARIO PÚBLICO. </h2>
   <p>
